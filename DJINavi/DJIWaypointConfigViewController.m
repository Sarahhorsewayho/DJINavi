...
- (void)initUI
{
    self.altitudeTextField.text = @"3"; //Set the altitude to 20
    self.autoFlightSpeedTextField.text = @"2"; //Set the autoFlightSpeed to 8
    self.maxFlightSpeedTextField.text = @"2"; //Set the maxFlightSpeed to 10
    [self.actionSegmentedControl setSelectedSegmentIndex:2]; //Set the finishAction to DJIWaypointMissionFinishedGoHome
