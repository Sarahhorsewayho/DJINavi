...
/**
 *  Recieves the stream data sent from the payload device. The stream data is sent
 ...
 *  <code>DJIPayload_SwitchState</code>
 ...
 *  
 *  @return The widget corresponding to the widget type and the index. `nil` if the widgets are not ready or there is no widget corrsponding  to the widget type and the index.
 */
